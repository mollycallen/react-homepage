...
import { faCloudSun, faAngleDoubleRight } from "@fortawesome/free-solid-svg-icons"
                    ...
                    {isLoading ? <p>Loading Weather data...</p> :
                        <div className='weather-details'>
                            <div className="current">
                                ...
                                <div>
                                    <div className='feels-like standout' >
                            ...
                            </div> {/* <div className='credit small-text'>* Data from <a href="https://open-meteo.com/" target='_blank' rel='noreferrer'>Open-Meteo.com</a></div> */}
                            <div className='btn-div'>
                                <button className='btn' onClick={changeCoordinates} >
                                    <FontAwesomeIcon className='icon' icon={faCloudSun} ></FontAwesomeIcon>
                                    Get Your Weather&nbsp;<FontAwesomeIcon icon={faAngleDoubleRight}></FontAwesomeIcon>
                                </button>
                            </div>
                        </div>
                    }
